...
public class ClassRoomTest extends TestCase {
    ...
    public void setUp() throws Exception {
        Student student1 = new Student("Aasif", 1, Optional.of("Java"));
        Student student2 = new Student("Azeem", 2, Optional.empty());
        Student student3 = new Student("Ali", 3, Optional.empty());
    ...
    public void testGetStudentsWithoutSubject_CorrectIfReturnList() {
        List<Student> expectedStudents = Arrays.asList(new Student("Azeem", 2, Optional.empty()),
                new Student("Ali", 3, Optional.empty()));

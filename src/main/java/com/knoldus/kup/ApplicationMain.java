...
class ApplicationMain {
    ...
    public static void main(final String[] args) {
        ...
        Student student1 = new Student(
                "Aasif", student1RollNo, Optional.of("Java"));
        Student student2 = new Student(
                "Azeem", student2RollNo, Optional.empty());
        Student student3 = new Student(
                "Ali", student3RollNo, Optional.empty());
        Student student4 = new Student(
                "Akshit", student4RollNo, Optional.of("Spring"));
        Student student5 = new Student(
                "Rohit", student5RollNo, Optional.of("PHP"));
        Student student6 = new Student(
                "Mayank", student6RollNo, Optional.of("React"));
        Student student7 = new Student(
                "Shubham", student7RollNo, Optional.of("Angular"));
        Student student8 = new Student(
                "Prince", student8RollNo, Optional.of("Python"));
        Student student9 = new Student(
                "Prince", student9RollNo, Optional.of("Angular"));
